        ...
        <div class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
            <div class="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
                <nav class="flex items-center gap-2 text-xs font-medium">
                    ...
                    <a href="#" onclick="openCartDrawer(); return false;" class="text-gray-500 hover:text-primary">Cart</a>
                    <span class="text-gray-300">/</span>
                ...
                <div class="lg:col-span-8 space-y-4">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        <div class="bg-gray-50 px-4 py-2 border-b border-gray-200 flex items-center gap-2">
                            <div
                                class="w-5 h-5 bg-primary text-white rounded-full flex items-center justify-center text-xs font-bold">
                                1</div>
                        ...
                        <div class="p-4 grid gap-4">
                            ...
                            <div class="grid sm:grid-cols-3 gap-3">
                                <div class="sm:col-span-1">
                                    <label class="block text-xs font-semibold text-gray-600 mb-1">Full Name <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="name" required value="{{ old('name', $user?->name) }}"
                                        class="w-full h-9 px-3 border rounded-md text-sm focus:ring-1 focus:ring-primary focus:border-primary border-gray-300"
                                        placeholder="Full Name">
                                    @error('name') <p class="text-xs text-red-500 mt-0.5">{{ $message }}</p> @enderror
                                </div>
                                <div class="sm:col-span-1">
                                    <label class="block text-xs font-semibold text-gray-600 mb-1">Phone <span
                                            class="text-red-500">*</span></label>
                                    <div class="flex">
                                        <span
                                            class="h-9 px-2 bg-gray-100 border border-r-0 border-gray-300 rounded-l-md flex items-center text-xs text-gray-500">+88</span>
                                        <input type="tel" name="phone" required value="{{ old('phone', $user?->phone) }}"
                                            class="flex-1 h-9 px-3 border rounded-r-md text-sm focus:ring-1 focus:ring-primary focus:border-primary border-gray-300"
                                            placeholder="01XXX...">
                                    </div>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-600 mb-2">Delivery Zone <span
                                        class="text-red-500">*</span></label>
                                <div class="flex flex-wrap gap-2">
                                    @foreach($shippingZones as $index => $zone)
                                        <label class="relative cursor-pointer group flex-1 sm:flex-none">
                                            ...
                                            <div
                                                class="px-3 py-2 border border-gray-200 rounded-md peer-checked:border-primary peer-checked:bg-blue-50 peer-checked:text-primary hover:bg-gray-50 transition text-center min-w-[120px]">
                                                <div class="text-xs font-bold">{{ $zone->name }}</div>
                                                <div class="text-[10px] text-gray-500 peer-checked:text-blue-600">
                                                    {{ money($zone->shipping_cost) }} - {{ $zone->estimated_days }}</div>
                                            </div>
                                            <div
                                                class="absolute -top-1 -right-1 w-3 h-3 bg-primary rounded-full items-center justify-center hidden peer-checked:flex">
                            ...
                            <div class="grid sm:grid-cols-4 gap-3">
                                <div class="sm:col-span-1">
                                    <label class="block text-xs font-semibold text-gray-600 mb-1">District <span
                                            class="text-red-500">*</span></label>
                                    <select name="district" required
                                        class="w-full h-9 px-2 border rounded-md text-sm focus:ring-1 focus:ring-primary border-gray-300 bg-white">
                                ...
                                <div class="sm:col-span-1">
                                    <label class="block text-xs font-semibold text-gray-600 mb-1">Area/City <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="city" required value="{{ old('city') }}"
                                        class="w-full h-9 px-3 border rounded-md text-sm focus:ring-1 focus:ring-primary border-gray-300"
                                        placeholder="e.g. Uttara">
                                </div>
                                <div class="sm:col-span-2">
                                    <label class="block text-xs font-semibold text-gray-600 mb-1">Full Address <span
                                            class="text-red-500">*</span></label>
                        ...
                        <div class="p-4">
                            ...
                            <div class="grid grid-cols-3 gap-3 mb-4">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div
                                        class="h-full flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 peer-checked:border-green-500 peer-checked:bg-green-50 transition">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div
                                        class="h-full flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 peer-checked:border-pink-500 peer-checked:bg-pink-50 transition">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div
                                        class="h-full flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 peer-checked:border-orange-500 peer-checked:bg-orange-50 transition">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button type="button"
                                                    ...
                                                    class="text-pink-500 hover:text-pink-700"><i
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="text" name="bkash_trx_id" placeholder="e.g. 8N72KS92JD"
                                            class="w-full h-9 px-3 border border-pink-300 rounded-md text-sm uppercase focus:ring-pink-500 focus:border-pink-500">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col sm:flex-row gap-4">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button type="button"
                                                    ...
                                                    class="text-orange-500 hover:text-orange-700"><i
                                                        class="far fa-copy"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-1">
                                        ...
                                        <input type="text" name="nagad_trx_id" placeholder="e.g. N8K72J92"
                                            class="w-full h-9 px-3 border border-orange-300 rounded-md text-sm uppercase focus:ring-orange-500 focus:border-orange-500">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                ...
                                <input type="text" name="notes" placeholder="Special instructions..."
                                    class="w-full h-9 px-3 border rounded-md text-xs border-gray-200 focus:border-primary">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-4 bg-gray-50 border-t border-gray-200">
                            ...
                            <div class="flex gap-2 mb-4">
                                <input type="text" name="coupon" id="couponCode" placeholder="Coupon Code"
                                    class="flex-1 h-8 px-3 text-xs border border-gray-300 rounded focus:border-primary">
                                <button type="button" id="applyCouponBtn"
                                    class="h-8 px-3 bg-gray-800 text-white text-xs rounded hover:bg-gray-700 transition">Apply</button>
                            </div>
                            ...
                            <button type="submit"
                                class="w-full bg-primary text-white py-3 rounded-lg font-bold text-sm hover:bg-blue-700 transition shadow-lg shadow-blue-200">
                                Confirm Order
                            </button>

                            <div
                                class="mt-3 flex justify-center gap-3 opacity-50 grayscale hover:grayscale-0 transition duration-300">
