...
<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h3 class="text-2xl font-bold text-gray-800">Edit Static Page</h3>
            <p class="mt-1 text-sm text-gray-500">Update content, SEO metadata and publication settings.</p>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Public URL: /pages/{{ old('slug', $page->slug) }}</p>
                </div>
