        ...
        <form action="{{ route('admin.settings.update') }}" method="POST" x-data="{ activeTab: 'general' }"
            ...
            <div class="border-b border-gray-200 bg-white">
                <div class="flex overflow-x-auto">
                    ...
                    <button type="button" @click="activeTab = 'order'"
                        :class="activeTab === 'order' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="px-6 py-4 text-sm font-semibold border-b-2 transition whitespace-nowrap">
                    ...
                    <button type="button" @click="activeTab = 'policy'"
                        :class="activeTab === 'policy' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="px-6 py-4 text-sm font-semibold border-b-2 transition whitespace-nowrap">
                ...
                <div x-show="activeTab === 'order'" x-transition x-cloak>
                    ...
                    <div class="space-y-6 max-w-2xl">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Orders will be numbered as: PREFIX-001, PREFIX-002, etc.
                            </p>
                        </div>
                ...
                <div x-show="activeTab === 'seo'" x-transition x-cloak>
                    ...
                    <div class="space-y-6 max-w-2xl">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Brief description for search engines (150-160 characters)
                            </p>
                        </div>
            ...
            <div class="flex items-center justify-end gap-4 px-6 md:px-8 py-6 bg-gray-50 border-t border-gray-200">
                <a href="{{ route('admin.dashboard') }}"
                    class="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition">
                    Cancel
                </a>
