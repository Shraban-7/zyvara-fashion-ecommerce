        ...
        <div class="max-w-2xl w-full text-center">
                ...
                <div class="relative inline-block">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="bg-white rounded-full p-6 shadow-lg">
                            <svg class="h-16 w-16 md:h-20 md:w-20 text-primary" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
                ...
                <div class="grid md:grid-cols-2 gap-4 text-left">
                    ...
                    <div class="flex items-start">
                        <i class="fas fa-search text-primary mt-1 mr-3"></i>
                        <div>
                    ...
                    <div class="flex items-start">
                        <i class="fas fa-shopping-bag text-primary mt-1 mr-3"></i>
                        <div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a href="{{ route('home') }}"
                    class="inline-flex items-center justify-center bg-primary text-white py-3 px-8 rounded-lg font-medium hover:bg-primary-600 transition shadow-md hover:shadow-lg">
                    <i class="fas fa-home mr-2"></i>Back to Home
                </a>
                <a href="{{ route('products.index') }}"
                    class="inline-flex items-center justify-center border-2 border-primary text-primary py-3 px-8 rounded-lg font-medium hover:bg-primary hover:text-white transition">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="flex flex-wrap justify-center gap-2">
                    <a href="{{ route('products.index') }}?category=men"
                        class="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium hover:bg-primary hover:text-white transition">
