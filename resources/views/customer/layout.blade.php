        ...
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="lg:w-64 flex-shrink-0">
                    ...
                    <!-- Navigation Menu -->
                    <nav id="dashboard-nav" class="hidden lg:block bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4 bg-primary text-white">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-primary font-bold text-lg">
                        ...
                        <ul class="py-2">
                            <li>
                                <a href="{{ route('customer.dashboard') }}"
                                    class="flex items-center gap-3 px-4 py-3 hover:bg-primary-50 transition {{ request()->routeIs('customer.dashboard') ? 'bg-primary-50 text-primary border-r-4 border-primary' : 'text-gray-700' }}">
                            ...
                            <li>
                                <a href="{{ route('orders.index') }}"
                                    class="flex items-center gap-3 px-4 py-3 hover:bg-primary-50 transition {{ request()->routeIs('orders.*') ? 'bg-primary-50 text-primary border-r-4 border-primary' : 'text-gray-700' }}">
                            ...
                            {{-- <li>
                                <a href="{{ route('customer.wishlist') }}"
                                    class="flex items-center gap-3 px-4 py-3 hover:bg-primary-50 transition {{ request()->routeIs('customer.wishlist') ? 'bg-primary-50 text-primary border-r-4 border-primary' : 'text-gray-700' }}">
                            ...
                            <li>
                                <a href="{{ route('customer.reviews') }}"
                                    class="flex items-center gap-3 px-4 py-3 hover:bg-primary-50 transition {{ request()->routeIs('customer.reviews') ? 'bg-primary-50 text-primary border-r-4 border-primary' : 'text-gray-700' }}">
                ...
                <main class="flex-1">
                    @if(session('success'))
                        <div
                            class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg mb-6 flex items-start gap-3">
                    ...
                    @if(session('error'))
                        <div
                            class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg mb-6 flex items-start gap-3">
