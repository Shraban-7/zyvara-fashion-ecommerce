        ...
        <div class="max-w-4xl mx-auto px-4">
                                ...
                                <div class="flex gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span
                                                class="text-lg font-bold text-gray-900">৳{{ number_format($item->subtotal, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="font-medium text-gray-900">৳{{ number_format($order->shipping_cost ?? 0, 2) }}</span>
                                </div>
                                ...
                                @if($order->tax_amount && $order->tax_amount > 0)
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium text-gray-900">৳{{ number_format($order->tax_amount, 2) }}</span>
                                    </div>
                                @endif
                ...
                <div class="space-y-4">
                    ...
                    @foreach($statusSteps as $key => $step)
                        ...
                        <div class="flex gap-4">
                            <div class="flex flex-col items-center">
                                <div
                                    class="w-4 h-4 rounded-full border-4 {{ $isCompleted ? 'bg-green-500 border-green-100' : ($isCurrent ? 'bg-yellow-500 border-yellow-100' : 'bg-gray-300 border-gray-200') }}">
                                </div>
                                @if(!$isLast)
                            ...
                            <div class="{{ !$isLast ? 'pb-8' : '' }}">
                                <p class="font-semibold {{ $isCompleted || $isCurrent ? 'text-gray-900' : 'text-gray-500' }}">
                                    {{ $step['label'] }}
                                    @if($isCurrent)
                                        <span class="ml-2 text-xs bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full">In
                                            Progress</span>
                                    @endif
                                </p>
            ...
            <div class="text-center mt-8 text-sm bg-blue-50 rounded-xl p-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="mailto:support@spinnerfashion.com" class="text-primary hover:underline font-semibold">
                        <i class="fas fa-envelope mr-1"></i>
                        Email Support
                    </a>
                    <span class="hidden sm:inline text-gray-400">|</span>
                    <a href="tel:+8801712345678" class="text-primary hover:underline font-semibold">
