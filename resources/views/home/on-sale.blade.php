...
<section class="py-6 md:py-10">
    <div class="max-w-7xl mx-auto px-2 sm:px-4">
        ...
        <div class="flex items-center justify-between mb-4 md:mb-6">
            <div>
                <h2 class="text-lg md:text-2xl font-bold text-brand-black">On Sale</h2>
                <p class="text-xs md:text-sm text-brand-gray">Fresh styles just dropped</p>
            </div>
            <a href="{{ route('products.index', ['filter' => 'on-sale']) }}" class="text-brand-blue text-sm font-semibold flex items-center gap-1 tap-effect">
                View All
