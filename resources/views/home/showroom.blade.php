...
<section class="py-8 md:py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="text-center mb-6 md:mb-8">
            <h2 class="text-xl md:text-3xl font-bold text-black mb-2">Visit Our Showroom</h2>
        ...
        <div class="grid md:grid-cols-2 gap-6 md:gap-8 items-stretch">
            ...
            {{-- Showroom Details --}}
            <div class="bg-light rounded-2xl p-5 md:p-8 flex flex-col justify-center">
                <h3 class="text-lg md:text-xl font-bold text-black mb-4 flex items-center gap-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-black text-sm md:text-base">Address</h4>
                            <p class="text-secondary text-xs md:text-sm">{{ $settings['contact_address'] ?? '' }}</p>
                        </div>
                    </div>
                    ...
                    <!-- <div class="flex gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-black text-sm md:text-base">Business Hours</h4>
                            <p class="text-secondary text-xs md:text-sm">Saturday - Thursday: 10:00 AM - 9:00 PM<br>Friday: 3:00 PM - 9:00 PM</p>
                        </div>
                    </div> -->
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-black text-sm md:text-base">Contact Us</h4>
                ...
                <!-- <a href="#" class="mt-6 inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-blue-600 transition tap-effect">
