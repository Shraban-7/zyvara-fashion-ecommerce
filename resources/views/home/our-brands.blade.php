            ...
            <div class="grid grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4 md:gap-5">
                @foreach ($ourBrands as $brand)
                    <a href="{{ route('products.index') }}?brands={{ $brand->slug }}" class="group block">
                        <div class="relative bg-white rounded-xl overflow-hidden transition-all duration-500 hover:scale-105">
                            {{-- Card Shadow & Border --}}
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-gray-100/50 to-white rounded-xl border border-gray-200 group-hover:border-primary/30 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-primary/10">
                            </div>
                            ...
                            <div class="relative">
                                {{-- Accent Bar --}}
                                <div
                                    class="h-1 bg-gradient-to-r from-primary via-blue-500 to-primary transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-700 ease-out">
                                </div>
                                ...
                                <div class="relative px-2.5 pb-2.5 sm:px-3 sm:pb-3">
                                    <div
                                        class="bg-gradient-to-r from-gray-50 to-gray-100/50 group-hover:from-primary group-hover:to-blue-600 rounded-lg p-1.5 sm:p-2 transition-all duration-500">
                                        <p
